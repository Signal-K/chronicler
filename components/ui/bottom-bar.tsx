...
import { Package, SettingsIcon, ShoppingBag } from "lucide-react"

type NavigationBarProps = {
  // onOpenAlmanac removed
  onOpenInventory: () => void
  onOpenShop: () => void
  onOpenSettings: () => void
}

export function NavigationBar({ onOpenInventory, onOpenShop, onOpenSettings }: NavigationBarProps) {
  return (
