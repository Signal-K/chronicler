...
@onready var tab_bar: HBoxContainer = $VBox/TabBarPanel/TabBar
@onready var water_label: Label = $VBox/HeaderPanel/Header/WaterLabel
@onready var coins_label: Label = $VBox/HeaderPanel/Header/CoinsLabel
@onready var level_label: Label = $VBox/HeaderPanel/Header/LevelLabel
@onready var time_label: Label = $VBox/HeaderPanel/Header/TimeLabel
